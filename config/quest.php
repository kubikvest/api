...
return [
    ...
    'points' => [
        '1d2d4455-bb0a-48f0-8970-63e4db6bc52c' => [
            ...
            'coords' => [
                'latitude'  => [58.5233, 58.5243],
                'longitude' => [31.2967, 31.2977],
            ],
            'prompt' => [],
        ],
        'c0614188-b320-43b7-9f5d-91f65249be0f' => [
        ...
        '01b1dfbb-0e8e-4879-89ec-e5d88fc88ce8' => [
            ...
            'prompt' => [
                20 => 'текст подсказки №1',
                40 => 'текст подсказки №2',
                60 => 'текст подсказки №3',
            ],
        ],
        '34508a1d-7a76-4363-8bb7-e9aaaffc8275' => [
            'title' => 'Задание №2',
