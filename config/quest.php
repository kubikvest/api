...
return [
    'quest' => [
        ...
        '74184cd8-b02a-4505-9416-b136468bfeaf' => [
            ...
            'title' => 'Ой, все!',
            'description' => 'Сложность - легкая/
                              Возрастная категория - 7+/
                              Протяженность - около 3-х км/
                              Работает - 09:00 - 19:00',
            'points' => [
    ...
    'points' => [
        ...
        '01b1dfbb-0e8e-4879-89ec-e5d88fc88ce8' => [
            ...
            'prompt' => [
                ...
                60 => 'Место на середине, в простанородье, "горбатого" моста, где влюбленные и молодожены оставляют замочки в знак любви.(Подойдите к этому объекту и еще раз нажмите "проверить ответ", чтобы получить следующее задание.)',
            ],
        ],
        '34508a1d-7a76-4363-8bb7-e9aaaffc8275' => [
            'title' => 'Задание №2',
            ...
            'prompt' => [
                ...
                60 => 'Лихудов корпус, что за Софийским собором, красивое здание с живописной деревянной лестницей.(Подойдите к этому объекту и еще раз нажмите "проверить ответ", чтобы получить следующее задание.)',
            ],
        ],
        '8fee48f5-ef57-48b8-a02c-daa17ce9e0f9' => [
            'title' => 'Задание №3',
            ...
            'prompt' => [
                ...
                60 => 'Кафе-чайхона "Сказка", там же пиццерия "Лимончелло" по ул. Большая Власьевская, 1.(Подойдите к этому объекту и еще раз нажмите "проверить ответ", чтобы получить следующее задание.)',
            ],
        ],
        'd9f83782-17d9-4d74-ad81-b5da732eacb2' => [
            'title' => 'Задание №4',
            ...
            'prompt' => [
                ...
                60 => 'Зона в центре пляжа, по дороге от Монумента Победы (кстати это единственный конный монумент в городе), что на Екатерининской горке до Кремлевского моста.(Подойдите к этому объекту и еще раз нажмите "проверить ответ", чтобы получить следующее задание.)',
            ],
        ],
        '6f3c2252-0f00-42ae-971c-718b35a21a1d' => [
            'title' => 'Задание №5',
            ...
            'prompt' => [
                ...
                60 => 'Инсталляция с резным медведем на скамейке возле универмага "Диез".(Подойдите к этому объекту и еще раз нажмите "проверить ответ", чтобы получить следующее задание.)',
            ],
        ],
        /**
         * Третий квест
