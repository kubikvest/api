...
return [
    ...
    'points' => [
        ...
        'ee62fcc0-d116-45a0-a942-d6a585e36c4b' => [
            ...
            'coords' => [
                'latitude'  => [58.5236, 58.5241],
                'longitude' => [31.2967, 31.2972],
            ],
            'prompt' => [],
        ],
        '01b1dfbb-0e8e-4879-89ec-e5d88fc88ce8' => [
            'title' => 'Задание №1',
            'description' => 'Посмотри какой чудесный вид открывается на город с центра горбатой переправы!',
            'coords' => [
                'latitude'  => [58.5236, 58.5241],
                'longitude' => [31.2967, 31.2972],
            ],
            'prompt' => [
                20 => 'Ищите скопление замочков по центру "той" и "этой" стороны!',
                40 => 'Встаньте по середине Кремлевского моста - красота то какая, лепота!',
                60 => 'Место на середине, в простанородье, "горбатого" моста, где влюбленные и молодожены оставляют замочки в знак любви.(Подойдите к этому объекту и еще раз нажмите "проверить место", чтобы получить следующее задание.)',
            ],
        ],
        '34508a1d-7a76-4363-8bb7-e9aaaffc8275' => [
            'title' => 'Задание №2',
        ...
        'f8658947-0341-4059-9692-45b4c6167f91' => [
            ...
            'coords' => [
                'latitude'  => [58.7000, 58.7000],
                'longitude' => [31.7000, 31.7000],
            ],
            'prompt' => [
        ...
        '00cf856c-e259-405a-9c01-4345f4310168' => [
            ...
            'coords' => [
                'latitude'  => [58.7777, 58.7777],
                'longitude' => [31.7777, 31.7777],
            ],
            'prompt' => [
