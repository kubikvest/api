...
return [
    ...
    'points' => [
        '1d2d4455-bb0a-48f0-8970-63e4db6bc52c' => [
            ...
            'coords' => [
                'latitude'  => [58.5244, 58.5253],
                'longitude' => [31.1415, 31.1439],
            ],
            'prompt' => [],
        ],
        'c0614188-b320-43b7-9f5d-91f65249be0f' => [
            'title' => 'Задание 1 точки рядом с домом',
            ...
            'coords' => [
                'latitude' => [58.5419, 58.5421],
                'longitude' => [31.2219, 31.2224],
            ],
            'prompt' => [
        ...
        '05132aee-a9fc-447d-bef6-4798e4f31bcf' => [
            'title' => 'Задание 3 зона рядом с домом',
        ...
        'c477f2c1-9368-4560-aaa6-19876a9acb6e' => [
            'title' => 'Задание 4 зона рядом с домом +-2',
            'description' => 'Добро пожаловать в самую пропасть Загородского конца!',
            'coords' => [
                'latitude'  => [58.5417, 58.5222],
                'longitude' => [31.2217, 31.2226],
            ],
            'prompt' => [
