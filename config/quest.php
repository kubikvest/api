...
return [
    ...
    'points' => [
        '1d2d4455-bb0a-48f0-8970-63e4db6bc52c' => [
            ...
            'coords' => [
                'latitude'  => [58.5220, 58.5239],
                'longitude' => [31.2699, 31.2724],
            ],
            'prompt' => [],
        ],
        'c0614188-b320-43b7-9f5d-91f65249be0f' => [
            ...
            'coords' => [
                'latitude' => [58.5151, 58.5170],
                'longitude' => [31.2713, 31.2745],
            ],
            'prompt' => [
        ...
        'e4e37339-b783-4f20-8eca-fb498366e496' => [
            ...
            'coords' => [
                'latitude'  => [58.5116, 58.5149],
                'longitude' => [31.2676, 31.2714],
            ],
            'prompt' => [
        ...
        '05132aee-a9fc-447d-bef6-4798e4f31bcf' => [
            ...
            'coords' => [
                'latitude'  => [58.5167, 58.5189],
                'longitude' => [31.2616, 31.2666],
            ],
            'prompt' => [
        ...
        'c477f2c1-9368-4560-aaa6-19876a9acb6e' => [
            ...
            'coords' => [
                'latitude'  => [58.5210, 58.5223],
                'longitude' => [31.2620, 31.2645],
            ],
            'prompt' => [
        ...
        '1bdf7da9-a290-405e-8d4d-3d43bac4f9d2' => [
            ...
            'coords' => [
                'latitude'  => [58.5235, 58.5248],
                'longitude' => [31.2710, 31.2738],
            ],
            'prompt' => [
        ...
        '01b1dfbb-0e8e-4879-89ec-e5d88fc88ce8' => [
            ...
            'coords' => [
                'latitude'  => [58.5204, 58.5232],
                'longitude' => [31.2778, 31.2861],
            ],
            'prompt' => [
        ...
        '34508a1d-7a76-4363-8bb7-e9aaaffc8275' => [
            ...
            'coords' => [
                'latitude'  => [58.5221, 58.5239],
                'longitude' => [31.2754, 31.2777],
            ],
            'prompt' => [
        ...
        '8fee48f5-ef57-48b8-a02c-daa17ce9e0f9' => [
            ...
            'coords' => [
                'latitude'  => [58.5171, 58.5182],
                'longitude' => [31.2697, 31.2716],
            ],
            'prompt' => [
        ...
        'd9f83782-17d9-4d74-ad81-b5da732eacb2' => [
            ...
            'coords' => [
                'latitude'  => [58.5186, 58.5238],
                'longitude' => [31.2760, 31.2782],
            ],
            'prompt' => [
        ...
        '6f3c2252-0f00-42ae-971c-718b35a21a1d' => [
            ...
            'coords' => [
                'latitude'  => [58.5232, 58.5244],
                'longitude' => [31.2842, 31.2868],
            ],
            'prompt' => [
        ...
        '4d2402d7-7699-436b-a12a-bd40ebcbc7e6' => [
            ...
            'coords' => [
                'latitude'  => [58.5286, 58.5297],
                'longitude' => [31.2835, 31.2947],
            ],
            'prompt' => [
        ...
        '4fd0bf6b-659c-4d9b-b446-306b68513ea9' => [
            ...
            'coords' => [
                'latitude'  => [58.5331, 58.5341],
                'longitude' => [31.2925, 31.2972],
            ],
            'prompt' => [
        ...
        'f8658947-0341-4059-9692-45b4c6167f91' => [
            ...
            'coords' => [
                'latitude'  => [58.5345, 58.5361],
                'longitude' => [31.2944, 31.2983],
            ],
            'prompt' => [
        ...
        '00cf856c-e259-405a-9c01-4345f4310168' => [
            ...
            'coords' => [
                'latitude'  => [58.5398, 58.5409],
                'longitude' => [31.2866, 31.2889],
            ],
            'prompt' => [
        ...
        '746505de-b53d-4ba6-9f49-db9eed343242' => [
            ...
            'coords' => [
                'latitude'  => [58.5418, 58.5425],
                'longitude' => [31.2209, 31.2225],
            ],
            'prompt' => [],
        ],
        '4d2402d7-7699-436b-a12a-bd40ebcbc7e2' => [
        ...
        'f8658947-0341-4059-9692-45b4c6167f92' => [
            ...
            'coords' => [
                'latitude'  => [58.5328, 58.5335],
                'longitude' => [31.2677, 31.2691],
            ],
            'prompt' => [
                20 => 'Прошли? Молодцы! Наверняка где-то рядом виднеется сказочный замок и слышны голоса детей.',
                40 => 'Вокруг этой детской площадки целых три места для перекуса: Шкипер, Наполи и La Chatte.',
        ...
        'de9f4fb0-6501-4a8d-a750-8df7e106fed2' => [
            ...
            'coords' => [
                'latitude'  => [58.5337, 58.5342],
                'longitude' => [31.2668, 31.2675],
            ],
            'prompt' => [
                20 => 'За четырехзвездочным паласом, она и находится.',
                40 => 'Из окон ресторана "На солнце" очень хорошо видна эта небольшая и тихая детская площадка.',
