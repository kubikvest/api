...
return [
    'quest' => [
        ...
        '74184cd8-b02a-4505-9416-b136468bfeaf' => [
            'title' => 'Окольный град',
            'description' => 'Сложность-средняя/Возрастная категория-14+/Протяженность-около 4-х км/Работает-круглосуточно',
            'points' => [
            ...
            'title' => 'Ой, все!',
            'description' => 'Сложность-легкая/Возрастная категория-7+/Протяженность-около 3-х км/Работает-09:00-19:00',
            'points' => [
            ...
            'description' => 'Сложность-легкая/Возрастная категория-7+/Протяженность-около 2,5 км/Работает-09:00-19:00',
            'points' => [
    ...
    'points' => [
        ...
        'ee62fcc0-d116-45a0-a942-d6a585e36c4b' => [
            ...
            'coords' => [
                'latitude'  => [58.5188, 58.5195],
                'longitude' => [31.2832, 31.2846],
            ],
            'prompt' => [],
        ],
        '01b1dfbb-0e8e-4879-89ec-e5d88fc88ce8' => [
            'title' => 'Задание №1',
            'description' => 'Сразу за горбатой переправой есть "деревянный" зоопарк.',
            'coords' => [
                'latitude'  => [58.5207, 58.5212],
                'longitude' => [31.2780, 31.2791],
            ],
            'prompt' => [
                20 => 'Это так же излюбленное место новгородских моржей.',
                40 => 'Ищи деревянные фигуры между мостом и кафе "На причале"',
                60 => 'База моржей, рядом с которой есть пеньки превращенные в резные фигуры.(Подойдите к этому объекту и еще раз нажмите "проверить место", чтобы получить следующее задание.)',
            ],
        ],
        '34508a1d-7a76-4363-8bb7-e9aaaffc8275' => [
            'title' => 'Задание №2',
        ...
        '6f3c2252-0f00-42ae-971c-718b35a21a1d' => [
            'title' => 'Задание №5',
            'description' => 'Ну и на последок, "присядьте на дорожку" с медведем!',
            'coords' => [
                'latitude'  => [58.5227, 58.5233],
                'longitude' => [31.2842, 31.2851],
            ],
            'prompt' => [
                20 => 'По пути к нему вы встретите уставшую туристку, корабль, и даже рисующего мальчика.',
                40 => 'На ручье Федора есть большой магазин, вот как раз подле него и сидит резной топтыгин.',
                60 => 'Инсталляция с резным медведем на скамейке возле универмага "Диез".(Подойдите к этому объекту и еще раз нажмите "проверить место", чтобы получить следующее задание.)',
            ],
        ],
        /**
         * Третий квест
        ...
        '746505de-b53d-4ba6-9f49-db9eed34324b' => [
            ...
            'coords' => [
                'latitude'  => [58.5303, 58.5309],
                'longitude' => [31.2895, 31.2907],
            ],
            'prompt' => [],
        ],
        '4d2402d7-7699-436b-a12a-bd40ebcbc7e6' => [
        ...
        '4fd0bf6b-659c-4d9b-b446-306b68513ea9' => [
            ...
            'coords' => [
                'latitude'  => [58.5334, 58.5340],
                'longitude' => [31.2928, 31.2941],
            ],
            'prompt' => [
        ...
        'f8658947-0341-4059-9692-45b4c6167f91' => [
            ...
            'coords' => [
                'latitude'  => [58.5348, 58.5358],
                'longitude' => [31.2961, 31.2978],
            ],
            'prompt' => [
        ...
        'de9f4fb0-6501-4a8d-a750-8df7e106fed0' => [
            'title' => 'Найдите https://goo.gl/VNIolR за https://goo.gl/5gPxDn',
            'description' => '004',
            'coords' => [
                'latitude'  => [58.5360, 58.5368],
                'longitude' => [31.2879, 31.2896],
            ],
            'prompt' => [
                20 => 'За четырехзвездочным паласом, есть выход к воде, он то вам и нужен!',
                40 => 'С этой пристани, за гостинницей, отличный вид на воды Волхова.',
                60 => 'Пристань на берегу Волхова за гостинницей "Парк Инн".(Подойдите к этому объекту и еще раз нажмите "проверить место", чтобы получить следующее задание.)',
            ],
        ],
        '00cf856c-e259-405a-9c01-4345f4310168' => [
            'title' => 'Задание №5',
            ...
            'coords' => [
                'latitude'  => [58.5400, 58.5406],
                'longitude' => [31.2872, 31.2886],
            ],
            'prompt' => [
